...
#'
#' This package is an add-on to the \pkg{'DImodels'} package.
#' It enables the fitting of multivariate repeated measures Diversity-Interactions (DI) models
#' (Kirwan \emph{et al.}, 2009;
#' Finn \emph{et al.}, 2013; Dooley \emph{et al.}, 2015; Moral \emph{et al.}, 2023). \cr \cr
#'
#' @details
#'
#' \cr
...
#' Methods in Ecology and Evolution, 14(9), pp.2250-2258. \cr \cr
#'
...
#' SIAM Journal on Numerical Analysis, 10(2), pp.327-344. \cr \cr
#'
#' @seealso
#' This package:
