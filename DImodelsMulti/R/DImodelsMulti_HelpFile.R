...
#' subscript \eqn{t} in the instance that a dataset contains a single time point. \cr \cr
#'
...
#' Environmental and Ecological Statistics, 30(3), pp.555-574. \cr \cr
#'
